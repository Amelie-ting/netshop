 ...
 * @Description: 用户收货人地址信息持久层
 * @author hdm
 * @date 创建时间：2016年4月10日 下午4:39:25 @version=1.0
 */
public class AddessDaoImpl implements AddessDao {
	...
	public void addAddress(UserAddress addr) throws SQLException {
		...
		Object[] params = { addr.getA_uid(), addr.getA_uname(), addr.getA_state(), addr.getA_city(), addr.getA_county(),
				addr.getA_addr(), addr.getA_tel(), addr.getA_zip(), addr.getA_isDefault() };
	...
	public void update(UserAddress userAddr) throws SQLException {
		...
		Object[] params = { userAddr.getA_uname(), userAddr.getA_state(), userAddr.getA_city(), userAddr.getA_county(),
				userAddr.getA_addr(), userAddr.getA_tel(), userAddr.getA_zip(), userAddr.getA_isDefault(),
				userAddr.getA_id() };
		qr.update(sql, params);
